...
#include "../../receiveMusic/receive.h"
...
const QMetaObject receive::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_receive.data,
      qt_meta_data_receive,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
