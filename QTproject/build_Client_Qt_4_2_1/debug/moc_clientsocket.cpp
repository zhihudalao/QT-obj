...
QT_MOC_LITERAL(14, 136, 8), // "sigAudio"
QT_MOC_LITERAL(15, 145, 10), // "sigunAudio"
QT_MOC_LITERAL(16, 156, 5), // "sigBs"
QT_MOC_LITERAL(17, 162, 11) // "onReadyRead"

    },
    "ClientSocket\0sigReg\0\0user_t\0user\0"
    "sigLogin\0sigRoomName\0sigRoomList\0"
    "sigChatName\0sigChatList\0sigMasterExit\0"
    "sigChatText\0sigVideo\0sigunVideo\0"
    "sigAudio\0sigunAudio\0sigBs\0onReadyRead"
};
...
void ClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 10: _t->sigAudio((*reinterpret_cast< user_t(*)>(_a[1]))); break;
        case 11: _t->sigunAudio((*reinterpret_cast< user_t(*)>(_a[1]))); break;
        case 12: _t->sigBs((*reinterpret_cast< user_t(*)>(_a[1]))); break;
        ...
        {
            typedef void (ClientSocket::*_t)(user_t );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientSocket::sigAudio)) {
                *result = 10;
                return;
            }
        }
        {
            typedef void (ClientSocket::*_t)(user_t );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientSocket::sigunAudio)) {
                *result = 11;
                return;
            }
        }
